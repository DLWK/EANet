...
if __name__ == '__main__':
    ras =Backbonebd(n_channels=3, n_classes=1).cuda()
    input_tensor = torch.randn(4, 3, 96, 96).cuda()
    xb, xd, xf = ras(input_tensor)
    print(xb.shape)
